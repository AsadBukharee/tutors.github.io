...
! function(a, b) {
    ...
    c.Instance = function() {
        ...
        var d = this,
            ...
            j = function() {
                ...
                g.iframe && a.push(jQuery(g.iframe[0].contentWindow)), a.forEach(function(a) {
                    a.on("keyup", u), e.hide.onOutsideClick && a[0].addEventListener("click", o, !0), e.hide.onOutsideContextMenu && a[0].addEventListener("contextmenu", o, !0), e.position.autoRefresh && a.on("resize", d.refreshPosition)
            ...
            p = function() {
                d.addElement("widget"), d.addElement("header"), d.addElement("message"), d.addElement("window", window), d.addElement("container", e.container), e.iframe && d.addElement("iframe", e.iframe);
            ...
            v = function() {
                var a = [g.window];
                g.iframe && a.push(jQuery(g.iframe[0].contentWindow)), a.forEach(function(a) {
                    a.off("keyup", u), e.hide.onOutsideClick && a[0].removeEventListener("click", o, !0), e.hide.onOutsideContextMenu && a[0].removeEventListener("contextmenu", o, !0), e.position.autoRefresh && a.off("resize", d.refreshPosition)
        ...
        this.addElement = function(b, c, d) {
            ...
            return clearTimeout(h), k("hide", arguments), v(), d.trigger("hide"), d
        }, this.init = function(a, b) {
            if (!(a instanceof c.Instance)) throw "The " + d.widgetName + " must to be initialized from an instance of DialogsManager.Instance";
            return l(), d.trigger("init", b), q(a, b), p(), d.buildWidget(), d.attachEvents && d.attachEvents(), d.trigger("ready"), d
            ...
            if (e.position.enable) {
                ...
                g[b.of] && (b.of = g[b.of]), e.iframe && m(b), g[b.element].position(b)
            }
        }, this.setID = function(a) {
            return g.widget.attr("id", a), d
        }, this.setHeaderMessage = function(a) {
            return this.getElements("header").html(a), this
            ...
            return clearTimeout(h), g.widget.appendTo(g.container).hide(), k("show", arguments), d.refreshPosition(), e.hide.auto && (h = setTimeout(d.hide, e.hide.autoDelay)), j(), d.trigger("show"), d
        ...
        var a = this.getElements(),
            b = this.getSettings();
        a.widget.append(a.header, a.message), this.setHeaderMessage(b.headerMessage), this.setMessage(b.message)
        ...
        buildWidget: function() {
            ...
            var a = this.addElement("widgetContent"),
                b = this.getElements();
            if (a.append(b.header, b.message, b.buttonsWrapper), b.widget.html(a), this.getSettings("closeButton")) {
                var d = this.addElement("closeButton", '<div><i class="' + this.getSettings("closeButtonClass") + '"></i></div>');
                a.prepend(d)
            }
        },
        attachEvents: function() {
            this.getSettings("closeButton") && this.getElements("closeButton").on("click", this.hide)
        },
        onReady: function() {
            var a = this.getElements(),
                b = this.getSettings();
